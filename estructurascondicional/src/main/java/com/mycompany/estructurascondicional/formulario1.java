 ...
 */
package com.mycompany.estructurascondicional;
...
public class formulario1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NUMEROS POSITIVOS Y NEGATIVOS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         Integer N = Integer.parseInt(jTextField1.getText());
        
        if (N>=0) {
            jLabel2.setText("el numero es positivo");
            
        }else{ jLabel2.setText("el numero es negativo");
